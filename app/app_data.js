...
window.APP_DATA = {
  "meta": {
    "generated_at": "2026-06-16T21:00:27",
  ...
  "insights": [
    ...
    },
    {
      ...
      "body": "현재 주거비 지출은 $1,584지만 월말 예상은 $2,970입니다. 과거 평균 $1,514보다 +96% 높을 수 있어요.",
      "severity": "medium",
      "score": 84,
      "evidence": [
        "주거비 현재 지출: $1,584",
    ...
    },
    {
      "tier": "alert",
      "icon": "🧭",
      "title": "6월 예상 지출 $5,907",
      "body": "16일차 현재 지출 $3,151입니다. 이 속도면 월말 $5,907로, 최근 기준 $5,339 대비 $568 차이로 마감될 수 있어요.",
      "severity": "medium",
      "score": 72,
      "forecast": {
        "expense": 5907.43,
    ...
    },
    {
      "tier": "insight",
      "icon": "🔮",
      "title": "90일 후 예상 현금 $6,469",
      "body": "최근 월 순저축 중앙값 $1,090 기준, 현재 현금 $3,200에서 3개월 뒤 약 $6,469으로 예상됩니다. 현금흐름은 안정적입니다.",
      "severity": "good",
      "score": 55,
      "top": false
    },
  ...
  "action_items": {
    "now": [
      "남은 14일 하루 $156 이하로 쓰면 최근 지출 기준선($5,339)에 근접"
    ],
    "keep": [
      "평소 저축률 30% 유지 습관"
    ],
