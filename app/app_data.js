...
window.APP_DATA = {
  "meta": {
    "generated_at": "2026-06-21T21:00:28",
  ...
  "insights": [
    ...
    },
    {
      "tier": "insight",
      "icon": "🧭",
      "title": "6월 예상 지출 $5,451",
      "body": "21일차 현재 지출 $3,816입니다. 이 속도면 월말 $5,451로, 최근 기준 $5,339 대비 $112 차이로 마감될 수 있어요.",
      "severity": "good",
      "score": 72,
      "forecast": {
        "expense": 5451.39,
  ...
  "action_items": {
    "now": [
      ...
      "남은 9일 하루 $169 이하로 쓰면 최근 지출 기준선($5,339)에 근접"
    ],
    "keep": [
      "평소 저축률 30% 유지 습관"
    ],
